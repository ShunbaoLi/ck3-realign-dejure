...
| **行台 / 帝国总督** (`tier_empire`) | 其直辖或下属王国中存在非本帝国法理土地 | 将其名下及所有下属封臣管辖的全部王国，**即时且永久更定为该帝国主头衔的法理** | 全面支持中华行台、宣抚使与大总督区法理规范 |
| **皇帝 / 霸权统摄大封臣** (`tier_empire` / `tier_hegemony`) | 封臣实际统辖的王国/帝国尚未归属于领主帝国/霸权法理 | 将该封臣名下及其下属的王国/帝国法理，**即时且永久划归为玩家主头衔的法理** | 规避百年法理漂移，实现真正的大一统敕定 |
